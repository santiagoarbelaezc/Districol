...
@Component({
    selector: 'app-home',
    imports: [NavbarComponent, HeaderComponent, AlmohadaVideoComponent, CarruselColchonesComponent, CarruselAlmohadasComponent, CardHomeComponent, PartnersComponent, FooterComponent],
