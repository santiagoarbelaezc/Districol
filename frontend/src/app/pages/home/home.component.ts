...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [NavbarComponent, HeaderComponent, AlmohadaVideoComponent, CarruselColchonesComponent, CarruselAlmohadasComponent, CardHomeComponent, FooterComponent],
